...
"""Render an SDDM-safe Umbra palette from Astralith's cached Matugen data."""
...
def cached_palette_path() -> Path:
    ...
    return Path(__import__("os").environ.get("XDG_CACHE_HOME", cache)) / "astralith" / "palette.json"
