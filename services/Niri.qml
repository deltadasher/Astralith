...
// Live compositor state. Niri exposes one newline-delimited JSON event stream
// for state and short-lived request sockets for actions.
QtObject {
    id: root
        ...
        parser: SplitParser {
            onRead: function(line) {
                ...
                try {
                    ...
                    console.warn("[Astralith/Niri] Invalid event:", error);
                    return;
                }
