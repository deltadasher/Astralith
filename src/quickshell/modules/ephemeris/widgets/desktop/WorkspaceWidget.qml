...
Item {
    ...
    function windowsFor(workspaceId) {
        return Compositor.windows.filter(function(window) {
    ...
    ColumnLayout {
        ...
        GridView {
            ...
            delegate: Item {
                ...
                Rectangle {
                    ...
                    MouseArea {
                        ...
                        hoverEnabled: true
                        cursorShape: Qt.PointingHandCursor
                        onClicked: Compositor.focusWorkspace(workspaceDelegate.modelData.id)
                    }
                        ...
                        Repeater {
                            ...
                            Rectangle {
                                ...
                                MouseArea {
                                    ...
                                    cursorShape: Qt.PointingHandCursor
                                    onClicked: {
                                        Compositor.focusWindow(modelData.id);
                                        ShellState.closeEphemeris();
                                    }
                                }
                            }
            ...
            Text {
                ...
                text: Compositor.available ? "WAITING FOR NIRI'S EVENT STREAM" : "REQUIRES A NIRI SESSION"
                color: Theme.muted
                font.family: Theme.fontMono
                font.pixelSize: 10
